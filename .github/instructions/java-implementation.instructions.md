...
- Treat `docs/project-status.md` as the shipped-scope map. Use `docs/README.md` and `docs/user-guide.md` as maps or targeted follow-up references, not as default front-to-back reads.
