...
- End with a concise Japanese report containing: completed updates, checks performed, open items or residual risks, and whether the phase is ready to be marked complete.
