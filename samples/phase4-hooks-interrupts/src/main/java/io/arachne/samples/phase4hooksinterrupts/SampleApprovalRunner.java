...
@Component
public class SampleApprovalRunner implements ApplicationRunner {

    private final AgentFactory agentFactory;
    private final LifecycleEventCollector lifecycleEventCollector;

    public SampleApprovalRunner(AgentFactory agentFactory, LifecycleEventCollector lifecycleEventCollector) {
    ...
    public void run(ApplicationArguments args) {
        ...
        System.out.println("Arachne Phase 4 hooks and interrupts sample");
