package io.arachne.samples.phase3redissession;
...
@EnableRedisIndexedHttpSession(redisNamespace = "arachne:phase3:sample")
public class Phase3RedisSessionApplication {
