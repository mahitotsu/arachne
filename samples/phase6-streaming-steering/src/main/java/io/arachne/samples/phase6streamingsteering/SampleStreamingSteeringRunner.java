...
@Component
public class SampleStreamingSteeringRunner implements ApplicationRunner {

    private final AgentFactory agentFactory;
    private final DemoStreamingSteeringModel demoModel;

    public SampleStreamingSteeringRunner(AgentFactory agentFactory, DemoStreamingSteeringModel demoModel) {
    ...
    public void run(ApplicationArguments args) {
        ...
        System.out.println("Arachne Phase 6 streaming and steering sample");
