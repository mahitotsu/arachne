...
@Component
public class ToolExecutionContextRunner implements ApplicationRunner {

    private final AgentFactory agentFactory;
    private final DemoRequestContext requestContext;

    public ToolExecutionContextRunner(AgentFactory agentFactory, DemoRequestContext requestContext) {
    ...
    public void run(ApplicationArguments args) {
        Agent agent = agentFactory.builder()
                .toolExecutionMode(com.mahitotsu.arachne.strands.tool.ToolExecutionMode.PARALLEL)
                .build();
        ...
        try {
            ...
            System.out.println("Arachne tool execution context sample");
