...
Use [concept.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/concept.md) for the sample story and capability intent.
Use [architecture.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/architecture.md) for service boundaries and runtime structure.
Use [apis.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/apis.md) and [contracts.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/contracts.md) for the contracts that skills must respect.
