...
Use [requirements.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/requirements.md) for what the sample must support.
Use [architecture.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/architecture.md) for runtime and development structure.
Use [apis.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/apis.md) and [contracts.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/contracts.md) for the boundaries each slice should respect.
...
Downstream services expose the minimal APIs and deterministic responses defined in [apis.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/apis.md).

### Gate 2

`case-service` can create, list, and serve a case projection using the contracts defined in [contracts.md](/home/akring/arachne/samples/marketplace-agent-platform/docs/contracts.md).
...
the full local composed runtime demonstrates workflow-service replica continuity with Redis-backed session restore.
