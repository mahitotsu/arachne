...
@Component
public class SampleSkillsRunner implements ApplicationRunner {

    private final AgentFactory agentFactory;
    private final DemoSkillsModel demoSkillsModel;

    public SampleSkillsRunner(AgentFactory agentFactory, DemoSkillsModel demoSkillsModel) {
    ...
    public void run(ApplicationArguments args) {
        ...
        System.out.println("Arachne Phase 5 skills sample");
