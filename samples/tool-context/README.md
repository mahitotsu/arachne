...
- `SampleToolContextRunner`: seeds a request-scoped id, builds the agent, and prints the observed state
...
spring:
  application:
    name: arachne-tool-context-sample
  main:
    banner-mode: off
