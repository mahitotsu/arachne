...
import com.mahitotsu.arachne.samples.delivery.deliveryservice.domain.DeliveryExecutionHistoryTypes.AgentUsageBreakdown;
...
public class AgentObservationSupport {
    ...
    public AgentObservationSupport(
            ...
            DeliveryExecutionHistoryStore historyStore) {
