...
public class RegistryServiceEndpointResolver implements ServiceEndpointResolver {
    ...
    private record RegistryDiscoverRequestPayload(String query, Boolean availableOnly) {
    }

    private record RegistryDiscoverResponsePayload(String service, String agent, String summary, java.util.List<RegistryServiceDescriptorPayload> matches) {
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    private record RegistryServiceDescriptorPayload(String serviceName, String endpoint, String requestPath, String status) {
    }
