...
@Validated
public class KitchenServiceProperties {
    ...
    public static final class Kitchen {
        ...
        @NotBlank
        private String endpoint = "http://kitchen-service:8080";
        ...
        @AssertTrue(message = "delivery.kitchen.endpoint must be an absolute http(s) URL")
